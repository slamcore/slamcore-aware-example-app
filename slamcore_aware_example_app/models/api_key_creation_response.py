...
T = TypeVar("T", bound="APIKeyCreationResponse")
...
class APIKeyCreationResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_key_creation_response.additional_properties = d
        return api_key_creation_response
